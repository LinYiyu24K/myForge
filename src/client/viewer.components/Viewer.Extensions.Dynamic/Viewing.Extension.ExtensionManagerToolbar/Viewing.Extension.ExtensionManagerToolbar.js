...
class ExtensionManagerToolbar extends MultiModelExtensionBase {
  ...
  createUI() {
    ...
    //注释：数据管理NewDataManagement 
    var newDataManagement = new Autodesk.Viewing.UI.Button('newDataManagement');
    newDataManagement.onClick = function(e) {
      //viewer.setViewCube('front');//设为后面的视图
    ...
    newDataManagement.addClass('dataManagement');
    newDataManagement.setToolTip('资料管理');
    ...
    this.subToolbar.addControl(newDataManagement);
